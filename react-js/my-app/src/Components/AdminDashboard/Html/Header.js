  ...
  return (
    <>
      <AppBar style={{backgroundColor:'darkslateblue'}}>
        ...
        >
          <Typography variant="h5">Seniorcare</Typography>
      ...
      >
        <Offcanvas.Header closeButton>
          <Offcanvas.Title style={{margin:'0px 20px',fontFamily:'Poppins',fontSize:'20px',fontWeight:'600'}}>Seniorcare</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
          <Slidebar1 />
        </Offcanvas.Body>
